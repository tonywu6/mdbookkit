...
Trait implementors may supply additional documentation next to their implementation. To
link to the implementations themselves instead of the traits, use fully qualified paths,
