...
There is **very limited support** on linking to many [built-in types][rust-types].

**Primitive types**:

Links to named primitive types _are_ resolved:
...
rust-analyzer as of version <ra-version>(version)</ra-version>:
