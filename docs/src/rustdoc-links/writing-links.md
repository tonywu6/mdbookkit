...
<figure>
  {% include "/crates/mdbook-rustdoc-links/tests/book_ambiguous_link/stderr/data.svg" %}
</figure>
...
<figure>
  {% include "/crates/mdbook-rustdoc-links/tests/book_unsupported_generics/stderr/data.svg" %}
</figure>
